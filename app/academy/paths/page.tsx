...
// structure using this portal's own course data, with Sales Training kept as
// its own dedicated section separate from the five technical paths.
const PATH_DESCRIPTIONS: Record<string, string> = {
  ...
  "sales-path": "Sales Training equips partner reps to pitch, position, and close Vantiq deals with confidence.",
};
...
export default function PathsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="mb-4 text-sm font-medium text-emphasis">Technical Training Paths</h2>
        <div className="space-y-6">
