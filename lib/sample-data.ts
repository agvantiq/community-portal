...
export const COURSE_CATALOG: CatalogCourse[] = [
  ...
  },
  {
    ...
    description: "Project structure, naming, and review habits that scale with a team.",
    duration: "Self-paced",
    level: "Intermediate",
    category: "technical",
    tags: ["DevOps"],
  ...
  },
  {
    ...
    description: "Architectural conventions that keep server-side projects consistent.",
    duration: "Self-paced",
    level: "Intermediate",
    category: "technical",
